...
//  ************************************************************************************************************************************
// Now we know how to parse the string, and in the previous chapter we learned how to make Node.js behave as a file server.... (right?)
// So up next we combine them to serve the file requested by the client. We're asked to create two html files, summer and winter
// Done. They live in modules
